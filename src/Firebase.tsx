...
const BestOffersObj: Offer[] = [
  /* Paste BestOffersObj array here */
];

const CommonOffersObj: Offer[] = [
  /* Paste CommonOffersObj array here */
];

// Function to check if an offer already exists in Firestore
...
// Function to upload data to Firestore (with duplicate check)
