export default function Post() {
  return (
    <div className="bg-[#101623] bg-[url(https://amaranoc.am/images/footer/home-add-application.png)] bg-no-repeat bg-cover w-full h-[586px] py-8 flex justify-center items-center">
      <div className="w-[1200px] h-[369px] bg-[#38403e]  border-[#636a68] rounded-[20px] border px-4 py-6 md:py-10 md:px-8 ">
