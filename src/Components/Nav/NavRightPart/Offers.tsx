...
export default function Offers() {
  ...
  return (
    <div className="pt-[30px]">
      ...
      <div>
        <h2 className="text-xl font-bold mt-[60px]">Լավագույն առաջարկներ</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 pr-5 gap-3 mt-5">
          {loading ? (
            <p>Loading...</p>
      ...
      <div>
        <h2 className="text-xl font-bold mt-[20px]">Սովորական առաջարկներ</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 pr-5 gap-3 mt-5">
          {loading ? (
            <p>Loading...</p>
